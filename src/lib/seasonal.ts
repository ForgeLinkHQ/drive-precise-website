...
const PROMPTS: Record<Season, SeasonalPrompt> = {
  ...
  spring: {
    ...
    body: "If the car has felt different since you hit something hard, spring is when it shows up as uneven tyre wear, a pull to one side, or a knock over speed bumps. Worth checking before it costs you a set of tyres.",
