            ...
            <div className="lg:col-span-2">
              <div className="max-w-2xl space-y-5 text-lg leading-relaxed">
                ...
                <p>
                  ...
                  months, we say six months. If something is fine, we say it's fine — and we'd
                  rather tell you that and have you come back next year than sell you a job you
                  didn't need and never see you again.
                </p>
                <p>
                  Where a job genuinely needs a ramp, or specialist equipment we don't carry, we say
                  so and arrange it. Where another specialist is better placed — tyres, alignment,
                  bodywork, glass — we'll tell you that too, and we can set it up for you.
                </p>
              </div>
